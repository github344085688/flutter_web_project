...
class ComponentStyle {
  ...
  static const AVERAGE_COLOR  = const Color(0xFFbbeedf);
  static const TITLE_TEXT_COLOR = const Color(0xFF9FC1BA);
  static const DIVIDER_COLOR = const Color(0xFFA4AFB7);
  static const MALL_FOCUS_BG = const Color(0xFF4b7078);
  static const ACCENT_COLOR = const Color(0xFFF48225);
  static const PRIMARY_COLOR = const Color(0xFFAD877A);
  static const INDICATOR_COLOR = const Color(0xFF2E3E4E);
