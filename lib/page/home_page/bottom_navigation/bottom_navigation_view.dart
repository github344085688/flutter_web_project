...
import 'package:flutter_web_project/page/home_page/bottom_navigation/fluid_button.dart';
import 'package:flutter_web_project/page/home_page/bottom_navigation/buttom_canvas.dart';
import 'package:flutter_web_project/page/home_page/bottom_navigation/event_bus.dart';

class BottomNavigationView extends StatefulWidget {
  final setActivity;
  final int currentIndex;

  const BottomNavigationView({Key? key, required this.currentIndex, this.setActivity})
      : super(key: key);
